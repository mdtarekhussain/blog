...
const EditBlogPage = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    // শুধুমাত্র নতুন ইমেজ থাকলে ইমেজ আপলোড করা হবে
    if (image) {
    ...
    try {
      ...
      if (response.data.success) {
        // সাকসেস মেসেজ দেখানোর পরিবর্তে সরাসরি ব্লগ লিস্টে রিডাইরেক্ট করুন
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto animate-fade-in-up animation-delay-500">
            Update your blog content and share your thoughts with the world
          </p>
        </div>
        ...
        {/* সাকসেস মেসেজ - এটি শুধুমাত্র ডিবাগিংয়ের জন্য, আপনি চাইলে রাখতে পারেন */}
        {isSuccess && (
              ...
              <div className="ml-4">
                ...
                <div className="mt-4">
                  <button
                    ...
                    className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-300 transform hover:scale-105 mr-3"
                  >
                    Back to Blog List
                  </button>
                  <button
                    onClick={resetSuccess}
                    className="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md shadow-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-300 transform hover:scale-105"
                  >
                    Continue Editing
                  </button>
                </div>
            ...
            <form onSubmit={onSubmitHandler}>
              ...
              <div className="flex justify-center space-x-4">
                <button
                  ...
                  onClick={() => router.push('/admin/blogList')}
                  disabled={isLoading}
                  className="px-8 py-4 font-bold rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-all duration-300 shadow-lg hover:shadow-xl bg-gray-200 text-gray-800 hover:bg-gray-300"
                >
                  Cancel
                </button>
                <button
